...
fn matches_rustcrypto_chacha20_for_RFC_inputs() {
    ...
    ]; // Pad with [0, 0] to make packable to [u32; M]
    ...
    ]; // Pad with [116, 3] to make packable to [u32; M]

    // FIXME: The endianness of Noir is FUCKED... these test vectors work upstream.
    ...
    //     0x64, 0x6c, 0x75, 0x69, 0x20, 0x65, 0x62,
    // ];
    ...
    //     0x8e, 0x0b, 0xb4, 0x42, 0x5e, 0x78, 0xf2,
    // ];
